...
class GroupInfoArgument {
  const GroupInfoArgument({
...
class GroupInfo extends StatefulWidget {
  ...
  final GroupInfoArgument argument;

  @override
  State<GroupInfo> createState() => _GroupInfoState();
}

class _GroupInfoState extends State<GroupInfo> with AppMixin {
  Stream? members;
  ...
  getMembers() async {
    DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
        .getGroupMembers(groupId: widget.argument.groupId)
        .then((val) {
      setState(() {
        members = val;
      });
              ...
              child: Row(
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundColor: Theme.of(context).primaryColor,
                    child: Text(
                      widget.argument.groupName.substring(0, 1).toUpperCase(),
                      style: const TextStyle(
