...
class NotificationsService {
  static const key =
      'AAAAnvqx7Io:APA91bEsDY5e0qwtmbKbbefPmbns9wn3vUHUdBdqCgHqjy1cpGlgjmmq57m5chRJSM3w_77Kzq55vP88GOe52VTpPYWLMOKiSuuTJX6bWvVAbNTf2oY6jO3aS1OUCasbhSCS3F7gr3oH';
  ...
  void firebaseNotification(context) {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) async {
      await Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) => ChatPage(
            argument: ChatArgument(uid: message.data['senderId']),
          ),
        ),
      );
    });
